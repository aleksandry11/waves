...
var folders = _gui2.default.create(_config.waves);
...
try {
    for (var _iterator = _config.waves[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    _createClass(GuiHelper, null, [{
        ...
        value: function create(config) {
            ...
            for (var i = 0; i < config.length; i++) {
                ...
                var colorStop2 = folder.addFolder('Color Stop 2');
        ...
        key: 'addColorStops',
        value: function addColorStops(folder, array) {
            for (var i = 0; i < 4; i++) {
                var stop = folder.addFolder('Color ' + (i + 1));
