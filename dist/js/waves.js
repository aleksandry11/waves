...
var Wave = function () {
    ...
    _createClass(Wave, [{
        ...
        key: 'createColor',
        value: function createColor(colorArr) {
            var _colorArr = _slicedToArray(colorArr, 3),
                r = _colorArr[0],
                g = _colorArr[1],
                b = _colorArr[2];
...
var Waves = function () {
    function Waves(canvas) {
        var useGui = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        ...
        if (useGui) {
            _gui2.default.open(_config.waves);
        }
    }
    ...
    _createClass(GuiHelper, null, [{
        ...
        value: function open(config) {
            ...
            for (var i = 0; i < config.length; i++) {
                ...
                var colorStops = folder.addFolder('Color Stops');
                GuiHelper.addColorStops(colorStops, config[i].stops);

                folders.push(folder);
            }

            var canvasFolder = GuiHelper.createCanvasSettings(gui, _config.canvasConfig);
        ...
        key: 'addColorStops',
        value: function addColorStops(folder, obj) {
            for (var i = 1; i < 4; i++) {
                folder.addColor(obj, 'color' + i);
            }
        }
    }, {
        key: 'createCanvasSettings',
        value: function createCanvasSettings(gui, config) {
